...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'api_user', 'age',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'User.sex'
        db.add_column(u'api_user', 'sex',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20),
                      keep_default=False)

        # Adding field 'User.proPic'
        db.add_column(u'api_user', 'proPic',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'api_user', 'age')

        # Deleting field 'User.sex'
        db.delete_column(u'api_user', 'sex')

        # Deleting field 'User.proPic'
        db.delete_column(u'api_user', 'proPic')
    ...
    models = {
        ...
        u'api.user': {
            ...
            'proPic': ('django.db.models.fields.files.ImageField', [], {'default': "''", 'max_length': '100'}),
            'sex': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '20'}),
